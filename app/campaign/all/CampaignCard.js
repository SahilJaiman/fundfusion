            ...
            <div className="max-w-sm gap-4 p-4 flex flex-col h-full hover:scale-[1.01] transition-all duration-300 cursor-pointer bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-blue-700">
                ...
                <div className="flex h-full flex-col justify-between p-2 ">
                    ...
                    <div className='mt-2'>
                        ...
                        <Rate allowHalf />
                            <a onClick={() => onHandleClick(campaign.value.id)} className="inline-flex group  items-center justify-center text-center mt-2 px-2 py-2 font-medium rounded-full text-sm p-2 dark:border-blue-500 dark:text-white dark:hover:text-blue-600 ">
